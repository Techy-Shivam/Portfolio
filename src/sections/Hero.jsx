...
gsap.from(".star svg",{
  ...
  return (
    ...
    <div className='main-container h-screen flex flex-col lg:justify-center items-start lg:pt-15 max-lg:pt-35'>
        ...
        <div className='flex h-[8vw] gap-1 cursor-pointer gradient-btn lg:h-[3vw]'>
          <img className='hover:scale-[1.1]' src={github} alt="" />
          <img className='hover:scale-[1.1]' src={linkdin} alt="" />
          <img className='hover:scale-[1.1]' src={x} alt="" />
        </div>
